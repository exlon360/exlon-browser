...
- User-selected image backgrounds with a settings import, enable, and remove flow, plus clearer wallpaper visibility behind transparent chrome and browser margins.
